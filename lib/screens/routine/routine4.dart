...
class _Routine4State extends State<Routine4>
    with AutomaticKeepAliveClientMixin<Routine4> {
  @override
  ...
  Widget _exerciseTile(BuildContext context, Exercise exercise) {
    return Padding(
        ...
        child: Card(
          ...
          child: ListTile(
            onTap: () async {
              await ExerciseDB(part: '등').updateNewExerciseData(exercise.name);
            },
            title: Text(
              exercise.name,
